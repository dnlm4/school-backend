...
import org.softfisticado.application.usecases.subject.CreateSubjectUseCase;
...
public class SubjectController {
    ...
    @POST
    public Uni<Response> save(Subject subject) {
        return createSubjectUseCase.save(subject)
                .onItem()
